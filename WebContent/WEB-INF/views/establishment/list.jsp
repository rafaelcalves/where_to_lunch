            ...
            <c:forEach var="establishment" items="${establishments}">
                <div class="row tableLine" id="${establishment.id}">
                    ...
                    <div class="establishmentControls">
                        <img class="editButton" src="/resources/img/edit.png" onclick="location.href='edit/${establishment.id}'">
                        <img class="removeButton" src="/resources/img/remove.png" onclick="location.href='remove/${establishment.id}'">
                    </div>
                </div>
            </c:forEach>
